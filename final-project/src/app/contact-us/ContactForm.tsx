...
const ContactForm = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        form.current?.reset()
        toast.success("Thanks for leaving us a message! Support team will answer you soon!")
    }
  ...
  return (
    ...
    <Card className="w-full m-8 max-w-4xl opacity-75">
        ...
        <CardContent className="p-8 grid md:grid-cols-2 grid-cols-1 justify-center">
          ...
          <form ref={form} className="space-y-4 mt-4 flex flex-col w-full" onSubmit={handleSubmit}>
            <div>
